...
public class Auth {
    ...
    public ResponseEntity<String> register(@RequestBody UsersProxy usersProxy){
    ...
    public ResponseEntity<String> verifyOtp(@RequestBody OtpVerificationReq otpVerificationReq){
